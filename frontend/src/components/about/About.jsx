  ...
  return (
    <div className='aboutContainer'>
      <div className='aboutContainer__top'>
        <p>Welcome to BorrowBook, your personal finance tracker for borrowed and lent money.</p>
        <h2>Created by</h2>
        <h1><a className="btn-shine">Amit Wasnik</a></h1>
        <div className='photo'>
          <img src={photo} alt="" />
        </div>
      </div>

      <div className="aboutContainer__contact">
        <div className='mail'>
          <h2>Contact:</h2>
          <a href="mailto:">amitwasnik1906@gmail.com</a>
        </div>

        <div class="main">
          <div class="up">
            <a href="https://www.instagram.com/amit__1906/" target='_blank'>
              <button class="card1" >
            ...
            <a href="https://www.linkedin.com/in/amit-wasnik-55448a263" target='_blank'>
              <button class="card2">
                <svg
          ...
          <div class="down">
            <a href="https://github.com/amitwasnik1906/" target='_blank'>
              <button class="card3">
